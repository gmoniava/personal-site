...
To add manual switcher to your site you mainly need:

- to add a UI switch component (for this I used `react-switch` component),
- and to take care of common theme management tasks: such as persisting the
  selected theme in local storage, applying the appropriate dark or light
  class to the HTML element, etc. (for this I used `next-themes` library)

Also there were few changes I had to do to the existing starter code to make the manual theme switching work:
