...
The page which renders a single blog post is: `app/blog/[slug]/page.tsx`.
This file was already present in the starter kit, I made minimal changes there.
Below I will simply explain some things that were already there.

You may notice usage of `generateStaticParams` inside that file,
