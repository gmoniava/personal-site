...
I built the blog for this website using the [Portfolio Starter Kit](https://vercel.com/templates/next.js/portfolio-starter-kit) from Vercel.
In this post, I explain some features I added (post filtering and a theme switcher), as well as some decisions and changes I made.
This is not a step-by-step tutorial, but should be enough to help you recreate a similar blog. Some familiarity with Nextjs is also assumed.
