...
summary: "I share my experience of creating a blog using Nextjs App router."
...
- `generateMetadata` can be used to dynamically generate metadata of a page. Since the blog
...
- As I mentioned currently the site would detect theme using the
  ...
  that you need to add [this](https://tailwindcss.com/docs/dark-mode#toggling-dark-mode-manually) line to `global.css`: `@custom-variant dark
