---
title: "Full Stack Movie App Built Using Nextjs App Router and PostgreSQL"
date: "2025-06-16T16:00:00Z"
summary: "Companion post of the movie app"
tags: ["software-development"]
---

Lately, I built a movie app using Next.js App Router and PostgreSQL to get more comfortable with the App Router features.
...
<TreeWithDescriptions
  data={[
      ...
      children: [
        {
          ...
          title: "(main)",
          key: "src/app/(main)",
          description: `Main app pages and layouts for user-facing routes. It uses route groups as you can see (folder name in parenthesis), which is a Nextjs feature.`,
          children: [
            {
              isFolder: false,
              title: "layout.tsx",
              key: "src/app/(main)/layout.tsx",
              description: `Defines the layout for the main user-facing pages. As the first layout under the (main) route group, it's the primary layout users will interact with across most routes.`,
            },
            {
              isFolder: false,
              title: "page.tsx",
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              isFolder: true,
              title: "movies",
              key: "src/app/api/movies",
              children: [
                {
                  isFolder: false,
                  title: "route.ts",
                  key: "src/app/api/movies/route.ts",
                  description: "Handles GET requests to search movies.",
                },
              ],
            },
            {
    ...
    },
    {
      ...
      title: "components",
      key: "src/components",
      description: "React components for client and server rendering.",
      children: [
        {
          isFolder: true,
          title: "client",
          key: "src/components/client",
          description: "Client-side React components (forms, buttons, sidebar, etc).",
          children: [
            {
              isFolder: false,
        ...
        },
        {
          ...
          description: "Server-side React components (movie list, header, etc).",
          children: [
            {
              isFolder: false,
