...
Since my experience in front-end development is mostly with React, I recently built a full stack movie app using Next.js App Router and PostgreSQL to get more comfortable with Next.js’s App Router features. The app lets you search, add, edit, and delete movies, and supports authentication. It is open source.
