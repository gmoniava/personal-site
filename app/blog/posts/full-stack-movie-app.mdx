      ...
      children: [
        {
          ...
          title: "(main)",
          key: "src/app/(main)",
          description: `Most pages of the application. It uses route groups (indicated by folder name in parenthesis), which is a Nextjs feature that allows you to organize files without affecting route's URL path.`,
          children: [
            {
              isFolder: false,
              title: "layout.tsx",
