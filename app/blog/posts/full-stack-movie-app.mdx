...
<TreeWithDescriptions
  data={[
    ...
    },
    {
      ...
      title: "app",
      key: "src/app",
      description: `This is Nextjs app directory. The Next.js app directory is basically a routing system that uses folders and special files like page.tsx and route.tsx to define routes.
It also supports layouts which is basically a UI that is shared between multiple pages.`,
      children: [
        {
          isFolder: true,
          title: "(main)",
