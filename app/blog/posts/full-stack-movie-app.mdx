...
<TreeWithDescriptions
  data={[
    ...
    },
    {
      ...
      title: "app",
      key: "src/app",
      description: `This is Nextjs app directory. The Next.js app directory is basically a routing system that uses folders and special files like page.tsx to define routes.
