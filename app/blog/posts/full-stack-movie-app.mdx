...
Lately, I built a full stack movie app using Next.js App Router and PostgreSQL to get more comfortable with the App Router features. The app lets users search, add, edit and delete movies.
