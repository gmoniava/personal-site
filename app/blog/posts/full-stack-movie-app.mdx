...
it would mean the whole app beneath my layout would skip SSR (due to the way `ClientOnly` hook works).
So I ended using a different [implementation](https://github.com/gmoniava/movie-app/blob/main/src/hooks/useLocalStorage.ts).
