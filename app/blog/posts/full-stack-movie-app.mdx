...
<TreeWithDescriptions
  data={[    
    ...
    },
    {
      ...
      description: "Contains server functions. Server functions allow client components to call async functions executed on the server. Such functions are used for data mutations.",
      children: [
        {
          isFolder: false,
          title: "auth.tsx",
          key: "src/server-functions/auth.tsx",
          description: "Implements login and logout server actions.",
        },
        {
          isFolder: false,
          title: "movies.tsx",
