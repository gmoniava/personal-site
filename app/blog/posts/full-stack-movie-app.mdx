...
summary: "This post aims to help readers understand the implementation of the app."
...
<TreeWithDescriptions
  data={[
    ...
    },
    {
      ...
      title: "app",
      key: "src/app",
      description: "This is Nextjs app directory. Folders inside it define route structures.",
      children: [
        {
          isFolder: true,
          title: "(main)",
