...
I read during the inline script and `useState` initializer were the same. This solution was based on this [post](https://ethanniser.dev/blog/a-clock-that-doesnt-snap).
