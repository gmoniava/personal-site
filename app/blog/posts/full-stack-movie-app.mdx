...
This post is a companion to the source code and gives an overview of the project structure (using a tree UI
component) along with explanations of files and directories.
