...
I would like to point out that this test can be still useful when someone has heart-related chest pain. Because if the pain is caused by a blockage, that suggests there may be a significant blockage of the arteries, so doing a stress test at that point can be more useful - because it's more likely to detect the problem
