...
the truth or to confirm/justify our desired conclusions. When the latter happens, it's called _motivated reasoning_.
This process is done by the unconscious mind. Let's look at some examples:
...
if that peson also develops cough in addition to runny nose, it may become more difficult to convince themselves that this is not a flu.
