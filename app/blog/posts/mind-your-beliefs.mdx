...
Also it is worth mentioning that motivated reasoning often has limits. For instance, in the first case above someone might convince themselves the runny nose is due to allergies — up to a point. But once they also develop a fever, it becomes much harder to ignore the more likely explanation.
